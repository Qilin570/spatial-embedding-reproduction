"""Table 5: RQ selectivity - Best results (fixed hyperparameters from paper).

Reproduces the 4 rows of Table 5 using the exact hyperparameters reported
in the paper:
  M2_dnn + AE_S1 + dH3 (256,128,128,64,64)
  M2_cnn + AE_C2 + cH4 (512,256,256,128)
  M2_dnn + AE_S3 + dH2 (128,64,64,32,32)
  M2_cnn + AE_S4 + cH4 (512,256,256,128)
...
def run(data_dir, output_dir, **kwargs):
    """Run Table 5 experiment with fixed hyperparameters from paper."""
    print("\n" + "=" * 60)
