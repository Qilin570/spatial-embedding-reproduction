"""Table 15: RQ selectivity - Full detailed results (CNN M2, cH1-cH5).

Runs all combinations: 4 AE configs x 5 CNN hyperparams (cH1-cH5),
...
def run(data_dir, output_dir, **kwargs):
    ...
    print("\n" + "=" * 60)
    print("TABLE 15: RQ Selectivity - Full CNN Configs (cH1-cH5)")
    print("=" * 60)
    ...
    # CNN only (matching paper Table 15)
    m2_cfgs = [cfg.M2_CNN_CONFIGS[f"cH{i}"] for i in range(1, 6)]
